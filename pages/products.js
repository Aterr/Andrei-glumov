...
const Products = ({products: {allContentfulProductPage: {edges: allProducts}}}) => {
    const [priceInputValueFrom, setPriceInputValueFrom] = useState(0)
    const [priceInputValueTo, setPriceInputValueTo] = useState(0)

    const [unchunkedArr, setUnchunkedArr] = useState(allProducts)
